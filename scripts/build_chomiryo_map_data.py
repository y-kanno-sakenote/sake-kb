...
for l in open('data/exports/chomiryo_by_pref.jsonl'):
    ...
    if _re.search(r'汁|鍋|煮|焼|干|漬|蔵品|塩辛|塩引|あえ|和え|炒|揚|丼|飯|めし|餅|団子|ラーメン|そば|うどん|料理|巻|寿司|すし|刺身|蒲鉾|かまぼこ|弁当|菓子|煎餅|せんべい|饅頭|まんじゅう|茶漬|の物|ずし|おでん|カツ|ケーキ|パン|なます',d['name']) and not _re.search(r'(塩|醤油|しょうゆ|つゆ|だし|たれ|ダレ|味噌|みそ|酢)(\(.*?\)|（.*?）)?$',d['name'].strip()): continue   # qa 2回目: 末尾が調味料語なら料理規則を適用しない（焼き塩・そばつゆ等）
